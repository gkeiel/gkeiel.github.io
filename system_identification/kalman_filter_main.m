...
Tf    = 0.10;
[u,t] = gensig('square',Tf/4,Tf,T);         % input and time
q     = 0^2;                              % variance of process
r     = 0.5^2;                              % variance of measurement
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%% KALMAN FILTER %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
x_0 = 0.5*ones( length(sys.A),1 );          % initial condition
P_0 = 100*diag( ones( length(sys.A),1 ) );    % initial covariance
[ x, y, K ] = kalman_filter( sysd, u, w', z, t, x_0, P_0, r, q );
